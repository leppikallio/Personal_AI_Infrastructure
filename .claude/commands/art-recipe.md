Export a successful Art generation as a reusable recipe template.
...
LOG_FILE="$ART_DIR/$IMAGE_DATE.jsonl"
...
1. Recipe file path
2. How to use: `bun ${PAI_DIR}/skills/Art/tools/generate-ulart-image.ts --prompt-file "$RECIPE_FILE" --skill art --output /path/to/new.png`

**Usage examples:**
- `/art-recipe /path/to/image.png` - Export with auto-generated name
- `/art-recipe /path/to/image.png mystical-forest` - Export with custom name
