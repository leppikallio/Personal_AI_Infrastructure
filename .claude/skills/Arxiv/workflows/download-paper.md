...
**When to Use:**
- User wants to read a specific paper
...
```
Tool: mcp__arxiv-mcp-server__list_papers
```

If paper exists locally, skip to Step 4 (read paper).
...
```
Tool: mcp__arxiv-mcp-server__download_paper
Parameters:
  paper_id: "[arxiv ID]"
  check_status: false
```
...
```
Tool: mcp__arxiv-mcp-server__read_paper
Parameters:
  paper_id: "[arxiv ID]"
```
...
2. **Deep analysis**: Use deep-analysis workflow
3. **Find related**: Search for citing/related papers
